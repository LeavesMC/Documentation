...
你可以通过添加移除时间参数（例如 `/bot remove <假人名> [移除时间]`）来在设定的时间后移除指定的假人。移除时间格式例如：`11h45m14s`。
...
- **动作名**: `mount`
- **动作参数**: `无`
- **描述**: 当假人开始执行这项动作时，假人将尝试骑乘 [曼哈顿距离](https://zh.wikipedia.org/wiki/%E6%9B%BC%E5%93%88%E9%A0%93%E8%B7%9D%E9%9B%A2) 小于等于 2 范围内的最近可骑乘实体。
